...
<svelte:head>
  ...
  <meta
    name="description"
    content="Varun is a creative designer, 3D works, video editing"  />
...
<PageTransition {innerHeight}>
  <div class="container">
    <div class="varun_dudeja">
      <svg width="462" height="50" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 171.63 121.36"><defs>
 
        <style>.cls-1{font-size:100px;fill:#e0e0e0;font-family:ElefantDisplay;}
        .cls-2{font-size:70px ;fill:#E0e0e0;font-family:PPNueueMachina-light;}
          </style></defs>
          <g id="Layer_2" data-name="Layer 2"><g id="Mortimer" data-name="Layer 1" class="mask intro-animation" style="--animation-order: 0;" >
        ...
        <noscript>
          <h1 style="font-size: 4vh; margin: 0 8vw 0 8vw;">
            Please enable your JavaScript! <br /> I have put a lot of effort into this Website, and would love
