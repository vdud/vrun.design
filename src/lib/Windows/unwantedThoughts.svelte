...
<div class="wrapper grid-area">
	<WindowElement width={350} height={340} parallax="very-slow" background="transparent" meta=" " title={'Unwated thoughts'} enlargeable={false} id={2}>
		<Swipe {...swipeConfig}>
			<SwipeItem
				><div class="container">
					<div>
...
<style>
	...
	p {
		...
		margin: -10px 0px;
		margin-top: -25px;
		animation: shuffle 16s cubic-bezier(0.83, 0, 0.15, 1) calc(var(--animation-order) * 200ms) infinite;
		padding: 0px 15px;
	...
	h1 {
		...
		margin: 10px 0;
		font-size: 1em;
		background: -webkit-linear-gradient(rgba(221, 221, 221, 0.589), rgba(255, 255, 255, 0.856));
		-webkit-background-clip: text;
		-webkit-text-fill-color: transparent;
	}
